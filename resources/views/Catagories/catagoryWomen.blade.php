...
<body>
    ...
    <center>
        <div class="catagoriesHeading">
            <p><strong><b>Women Products</b></strong></p>
        </div>
    </center>
    <center>
    ...
    <center>
        <section class="cup" style="margin-top: 5vw;">
            <div class="cupbanner">
                <img src="../imgs/Shirts/s3.jpg" alt="">
            </div>
    ...
    <center>
        <section class="pillow" style="margin-top: 5vw;">
            ...
            <div class="pillowbanner">
                <img src="../imgs/Rings/side1.jpg" alt="">
            </div>
        </section>
    </center>
    ...
    <center>
        <div class="catagoriesHeading" style="font-size: 5vh;">
            <p><strong><b>Necklace</b></strong></p>
        </div>
    </center>
    <center>
        <section class="cup" style="margin-top: 5vw;">
            <div class="cupbanner">
                <img src="../imgs/Necklace/n1.jpg" alt="">
            </div>
            <div class="cupitems slider">
