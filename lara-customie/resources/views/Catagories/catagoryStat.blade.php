...
<body>
    ...
    <center>
        <div class="catagoriesHeading">
            <p><strong><b>Stationary Products</b></strong></p>
        </div>
    </center>
    <center>
    ...
    <center>
        <section class="cup" style="margin-top: 5vw;">
            <div class="cupbanner">
                <img src="../imgs/Pens/sidep2.jpg" alt="">
            </div>
    ...
    <center>
        <section class="pillow" style="margin-top: 5vw;">
            ...
            <div class="pillowbanner">
                <img src="../imgs/Books/side1.jpg" alt="">
            </div>
        </section>
    </center>
